...
import mpltex.acs
from chebpy import BC, ETDRK4, ETDRK4FxCy
...
class SlabAB3d(object):
    ...
    def build_grid(self):
        ...
        self.qA_solver = OSFxyETDRK4z(La, Lb, Lc, Lx, Ly, Lz, 
                                      MsA, ds, lbc, rbc)
        self.qAc_solver = OSFxyETDRK4z(La, Lb, Lc, Lx, Ly, Lz, 
                                       MsA, ds, lbc, rbc)
        self.qB_solver = OSFxyETDRK4z(La, Lb, Lc, Lx, Ly, Lz, 
                                      MsB, ds, lbc, rbc)
        self.qBc_solver = OSFxyETDRK4z(La, Lb, Lc, Lx, Ly, Lz, 
                                       MsB, ds, lbc, rbc)
        self.lamA = config.grid.lam[0]
        self.lamB = config.grid.lam[1]
        self.lamY = config.grid.lam[2]
